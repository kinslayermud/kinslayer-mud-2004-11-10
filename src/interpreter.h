...
#define SCMD_NONARRATE		4
#define SCMD_NOCHAT			5
#define SCMD_NOSHOUT		6
#define SCMD_NOYELL			7
#define SCMD_NOWIZ			8
...
#define SCMD_OLC_KEDIT		8
#define SCMD_OLC_SAVEINFO	9

/* do_charge */
#define SCMD_CHARGE			0
#define SCMD_SKEWER			1
