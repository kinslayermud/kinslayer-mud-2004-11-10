...
/* These are the maximum base movement points a player can have depending on their race. */
int max_human_moves = 170;
int max_trolloc_moves = 280;
...
sh_int human_start_room = 500;
sh_int trolloc_start_room = 502;

/* virtual number of room that immorts should enter at by default */
sh_int immort_start_room = 1;

/* virtual number of room that frozen players should enter at */
sh_int frozen_start_room = 5;
