...
struct trig_data {
    ...
    cbyte attach_type;			/* mob/obj/wld intentions          */
    cbyte data_type;		        /* type of game_data for trig      */
    ...
    char first_arg[200];		/* First arg from arglist			*/
	char second_arg[200];		/* Second arg from arglist			*/
	char third_arg[200];		/* Third arg from arglist			*/
	char fourth_arg[200];		/* Fourth arg from arglist			*/
	char fifth_arg[200];		/* Fifth arg from arglist			*/
	int is_mount;
...
void act_mtrigger(char_data *ch, char *str, char_data *actor,
         char_data *victim, struct obj_data *object,
...
int drop_otrigger(struct obj_data *obj, char_data *actor);
void timer_otrigger(struct obj_data *obj);
int get_otrigger(struct obj_data *obj, char_data *actor);
int drop_wtrigger(struct obj_data *obj, char_data *actor);
int give_otrigger(struct obj_data *obj, char_data *actor,
         char_data *victim);
int receive_mtrigger(char_data *ch, char_data *actor,
         struct obj_data *obj);
void bribe_mtrigger(char_data *ch, char_data *actor,
         int amount);
int wear_otrigger(struct obj_data *obj, char_data *actor, int where);
int remove_otrigger(struct obj_data *obj, char_data *actor);
...
void do_stat_trigger(char_data *ch, struct trig_data *trig);
void do_sstat_room(char_data * ch);
void do_sstat_object(char_data * ch, struct obj_data * j);
...
/* Other */
void save_script_value(char *file_name, char *value);
